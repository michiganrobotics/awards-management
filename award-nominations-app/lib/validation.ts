...
export const awardSchema = z.object({
  ...
  callForNoms: z.string(),
  priorityRanking: z.string(),
  addedFrom: z.string(),
  typeOfImpact: z.string(),
  awardType: z.string(),
  academicCareerLevel: z.string(),
  reasonsToRemove: z.string(),
  limited: z.string(),
  nominator: z.string(),
  nominationViability: z.string(),
  selfNominations: z.string(),
  confidential: z.string(),
  currentlyManagedBy: z.string(),
  notes: z.string(),
  toBeManagedBy: z.string(),
  mitPaper: z.string(),
  nominationRequestFrom: z.string(),
  logo: z.string(),
  nominations: z.string(),
  awardRotation: z.string(),
  awardAnalysis: z.string(),
  heritageAward: z.string(),
  faculty: z.string(),
  faculty2: z.string(),
  faculty3: z.string(),
  candidateSuggestions2024: z.string(),
  candidateSuggestions: z.string(),
  suggestedCandidate: z.string(),
});
